...
const [someCheckbox, setSomeCheckbox] = useState(false); // checkbox ka naam aap change kar sakte ho, aur label bhi
      ...
      <div className="flex-1 overflow-hidden flex">
        ...
        <div className="w-full lg:w-2/3 overflow-auto border-r border-gray-200">
          <div className="p-4 sm:p-6 space-y-4">
            ...
            <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-4 sm:p-5">
              <label className="block text-sm font-semibold text-gray-800 mb-2">Event Name</label>
            ...
            <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-4 sm:p-5">
              <h2 className="text-base font-bold text-gray-800 mb-4">Registration Fields</h2>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {AVAILABLE_FIELDS.map((field) => (
                  <label key={field.id} className="flex items-center space-x-3 cursor-pointer group p-2 rounded-lg hover:bg-gray-50 transition-colors">
                    <input 
                      type="checkbox" 
                    ...
                    />
                    <span className="text-sm text-gray-700 font-medium group-hover:text-gray-900 transition-colors">{field.label}</span>
                  </label>
                ))}
              </div>
            </div>
        ...
        <div className="hidden lg:block w-1/3 bg-white overflow-auto">
          <div className="p-4 sm:p-6">
            ...
            <div className="space-y-2">
              {booths.map((booth) => (
                <div key={booth.id} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-3 border border-gray-200 shadow-lg">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-gray-800 font-semibold text-sm truncate">{booth.name}</span>
                    <button className="text-indigo-600 hover:text-indigo-700 transition-all flex-shrink-0">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 shadow-2xl">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            {booths.map((booth) => (
              <div key={booth.id} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-2 border border-gray-200 shadow-lg flex-shrink-0 min-w-[120px]">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-gray-800 font-semibold text-xs truncate">{booth.name}</span>
        ...
        <div className="fixed inset-0 bg-black/50 bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Event Password</label>
                <input
                  type="password"
                  name="eventPassword"
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md">
      <h2 className="text-xl font-semibold text-gray-800 mb-6">Add New Booth</h2>
      ...
      <div className="flex items-center justify-between mt-6">
        <span className="text-sm font-medium text-gray-700">Allow multiple</span>
