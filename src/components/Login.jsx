    ...
    return (
        <>
            <div className=" flex items-center justify-center p-5 mt-10">
                <div className="bg-white rounded-lg shadow-2xl p-10 w-full max-w-md shadow-xl">
                    <h2 className="text-3xl font-bold text-center text-gray-800 mb-8 underline">Login</h2>
                    <form id="loginForm" className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            <label for="name" className="block text-sm font-medium text-gray-700 mb-2">Name</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                        ...
                        <button
                            type="submit"
                            className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-semibold py-3 rounded-lg hover:shadow-lg hover:-translate-y-0.5 transform transition-all duration-200 active:translate-y-0"
                        >
                            Login
                        </button>
