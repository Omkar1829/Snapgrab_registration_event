                    ...
                    {activities.map((activity, index) => {
                        ...
                        return (
                            <div
                                key={activity.ID}
                                onClick={() =>
                                    navigate(`/Scan?activityId=${activity.ID}`)
                                }
                            >
                                <div
                                    className={`md:w-12 md:h-12 h-10 w-10 bg-gradient-to-br ${style.color} rounded-2xl flex items-center justify-center shadow-lg mb-4 transform group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300`}
                                >
